...
import { WebChatDetailsRoutingModule } from './web-chat-details-routing.module';
...
import { FilterPhoneNoPipe } from './filter-phone-no.pipe';
...
import { LinkifyUrlPipe } from './urllink.pipe';
...
@NgModule({
  declarations: [
    WebChatDetailsComponent,
    WebChatBoxComponent,
    WebChatSidebarComponent,
    WebChatUserCardComponent,
    FilterPhoneNoPipe,
    WebChatAgentDashboardComponent,
    LinkifyUrlPipe
  ],
  imports: [
    CommonModule,
    WebChatDetailsRoutingModule,
    FormsModule,
    AccordionModule,
    AutoCompleteModule,
    AvatarGroupModule,
  ...
  providers: [
    WebChatService,
    AudioRecordService,
    MailServiceAddedService,
    SharedService
]
})
export class WebChatDetailsModule { }
